...
int GlobalParams::lcirc_S;
int GlobalParams::lcirc_d;
int GlobalParams::lcirc_k;
int GlobalParams::lcirc_N;
int GlobalParams::lcirc_s1;
int GlobalParams::lcirc_s2;
int GlobalParams::lcirc_a;
int GlobalParams::lcirc_b;
int GlobalParams::lcirc_ax;
int GlobalParams::lcirc_ay;
int GlobalParams::lcirc_bx;
int GlobalParams::lcirc_by;
int GlobalParams::lcirc_abx;
int GlobalParams::lcirc_aby;
