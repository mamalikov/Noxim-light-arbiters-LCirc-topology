...
#include "selectionStrategies/Selection_HOPCOUNT_MAX.h"
#include "selectionStrategies/Selection_HOPCOUNT_MIN.h"
#include "selectionStrategies/Selection_DISTANCE_MIN.h"
#include "selectionStrategies/Selection_DISTANCE_MAX.h"
...
SC_MODULE(Router)
{
    ...
    friend class Selection_HOPCOUNT_MAX;
    friend class Selection_HOPCOUNT_MIN;
    friend class Selection_DISTANCE_MIN;
    friend class Selection_DISTANCE_MAX;
